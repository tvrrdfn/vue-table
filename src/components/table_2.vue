        ...
        .v-table__thead
            .v-table__thead__tr
                .v-table__thead__tr-th(
                    ...
                    //@mousedown="onMousedown($event, thead, index)"
                    //@mousemove="onMousemove($event, thead, index)"
                    //@mouseup="onMouseup($event, thead, index)"
...
<script type="text/javascript">
    ...
    export default {
        ...
        methods: {
            ...
            onMousedown(event, thead, index) {
                console.log('onMousedown', thead)
                this.handleEvent = {
                    dragStart: true,
